...
function Got_Player_Input(MyEvent) {
  switch (game_mode) {
    ...
    case 'running': {
      ...
      flapSound.currentTime = 0; // Reset sound for overlapping taps
      flapSound.play();
      break;
    }
    case 'over':
...
function triggerGameOver() {
  ...
  // Stop background music and play dying sound
  backgroundMusic.pause();
  backgroundMusic.currentTime = 0; // Reset music for next start

  dieSound.currentTime = 0; // Reset dying sound
  dieSound.play().catch((err) => console.error('Error playing die sound:', err));
}
...
function add_all_my_pipes() {
  ...
  add_pipe(3600, 50, 60);
  var finish_line = new MySprite('sprite1.png');
  finish_line.x = 3900;
...
bottom_bar.src = 'grass.png';

var bird = new MySprite('bird.png');
